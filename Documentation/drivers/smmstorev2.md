...
storage driver. Version 2 is now the default and only supported
version.
...
SMMSTORE version 2 requires a minimum alignment of 4 KiB, which should
...
region. It is mandatory to align the `SMMSTORE` region to the largest
flash erase block.
