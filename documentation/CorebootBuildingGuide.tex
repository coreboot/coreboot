...
Besides the tools above, you also need:

 \begin{itemize}
 \item git
 \item libncurses-dev (or ncursesw, ncurses, curses, pdcursesw, pdcurses)
 \item python
 \item perl
 \end{itemize}
...
More Chance you need to get a VGA BIOS.
{ \small
\begin{verbatim}
