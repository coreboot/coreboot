...
inline static uint16_t _be16toh(uint16_t value)
{
	const uint8_t *v = (const uint8_t *)&value;
	return v[0] << 8 | v[1];
}

static inline uint32_t _be32toh(uint32_t value)
{
	const uint8_t *v = (const uint8_t *)&value;
	return v[0] << 24 | v[1] << 16 | v[2] << 8 | v[3];
}

static inline uint64_t _be64toh(uint64_t value)
{
	const uint32_t *v = (const uint32_t *)&value;
	return (uint64_t)_be32toh(v[0]) << 32 | _be32toh(v[1]);
}

static inline uint16_t _le16toh(uint16_t value)
{
	const uint8_t *v = (const uint8_t *)&value;
	return v[1] << 8 | v[0];
}

static inline uint32_t _le32toh(uint32_t value)
{
	const uint8_t *v = (const uint8_t *)&value;
	return v[3] << 24 | v[2] << 16 | v[1] << 8 | v[0];
}

static inline uint64_t _le64toh(uint64_t value)
{
	const uint32_t *v = (const uint32_t *)&value;
