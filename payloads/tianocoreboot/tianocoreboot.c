...
static void prepare_handoff_blocks(void *hoblist)
{
	void *ptr = hoblist;
...
int main(void)
{
	...
	prepare_handoff_blocks((void *)hoblist);
	Hob.Raw = (void *)hoblist;
