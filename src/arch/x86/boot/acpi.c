...
acpi_header_t *acpi_write_dsdt(acpi_rsdp_t *rsdp, const acpi_header_t *src, unsigned long *current)
{
...
acpi_facs_t *acpi_write_facs(acpi_rsdp_t *rsdp, unsigned long *current)
{
...
unsigned long acpi_write_tables(unsigned long current)
{
	acpi_rsdp_t *rsdp;
	acpi_rsdt_t *rsdt;
	acpi_fadt_t *fadt;
	...
	acpi_write_hpet(rsdp, &current);
	acpi_write_madt(rsdp, &current);
	acpi_write_mcfg(rsdp, &current);
	acpi_write_srat(rsdp, &current);
	acpi_write_slit(rsdp, &current);

	dsdt = acpi_write_dsdt(rsdp, (acpi_header_t *)AmlCode, &current);
	facs = acpi_write_facs(rsdp, &current);
