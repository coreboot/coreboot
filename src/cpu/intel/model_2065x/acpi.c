 ...
 * taken from the ACPI dump on Lenovo X201T.
 */
...
static const char *const c_state_names[] = {"C0", "C1", "C1E", "C3", "C6", "C7"};
...
{
	// FIXME: Make this configurable in devicetree.
	int acpi_cstates[3] = { C_STATE_C1E, C_STATE_C3, C_STATE_C6 };
