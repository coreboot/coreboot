...
//		if ((unsigned long)g_early_i2c_config == 0x12c60000)
//			*addr |= 0x100;
//		while (1) ;
...
void i2c_init(int speed, int slaveadd)
{
	...
	/* FIXME: for debugging */
#error "left off here -- it seems that the variable is not holding its value..."
	if (i2c->regs == (struct s3c24x0_i2c *)0x12c60000)
		*addr |= 0x100;
	while (1) ;
	i2c_bus_init(i2c, g_current_bus);
