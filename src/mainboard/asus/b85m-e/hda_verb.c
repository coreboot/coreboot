...
static const u32 realtek_alc887_verbs[] = {
	...
	AZALIA_PIN_CFG(0, ALC887_SPDIF_OUT2, 0x40330000), // does not describe a jack or internal device
	...
	AZALIA_PIN_CFG(0, ALC887_PC_BEEP, 0x4024c601), // does not describe a jack or internal device
