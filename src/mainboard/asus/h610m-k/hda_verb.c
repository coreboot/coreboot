...
static const u32 realtek_alc897_verbs[] = {
	...
	AZALIA_PIN_CFG(0, 0x12, 0x4037c000), // does not describe a jack or internal device
	...
	AZALIA_PIN_CFG(0, 0x1d, 0x4044c601), // does not describe a jack or internal device
