...
/*
 * M3A78-EM uses GPIO 6 as PCIe slot reset, GPIO4 as GFX slot reset. We need to
...
#if 0	     /* not tested yet. */
/********************************************************
* M3A78-EM uses SB700 GPIO9 to detect IDE_DMA66.
...
{
	printk(BIOS_INFO, "Mainboard M3A78-EM Enable. dev=0x%p\n", dev);
