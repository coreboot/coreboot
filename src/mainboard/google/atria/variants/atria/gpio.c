...
static const struct pad_config gpio_table[] = {
	...
	/* GPP_A14:     ESPI_ALERT3_AIC_N; currently not used */
	PAD_NC(GPP_A14, NONE),
	/* GPP_A15: 	BT_RF_KILL_N */
	PAD_CFG_GPO(GPP_A15, 1, PLTRST),
	/* GPP_A16: 	Not used */
	PAD_NC(GPP_A16, NONE),
	/* GPP_A17:     ESPI_CS3_AIC_N; currently not used */
	PAD_NC(GPP_A17, NONE),
	...
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_B05, NONE, DEEP, NF4),
	...
	/* GPP_B11:     SOC_PDB_CTRL; Please make sure required rework is in place */
	...
	/* GPP_B17:     MOD_TCSS0_EDP_VDD_EN; currently not used */
	PAD_NC(GPP_B17, NONE),
	...
	/* GPP_B20:     ISH_GP_8_TCH_PNL_N */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_B20, NONE, DEEP, NF4),
	...
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_B24, UP_20K, DEEP, NF1),
	/* GPP_B25: 	UFS_RST_N */
	...
	/* GPP_D03: GPP_D3_PCH_IOE_MODE_EN; currently not used */
	PAD_NC(GPP_D03, NONE),
	/* GPP_D04: 	IMGCLKOUT_0 */
	...
	/* GPP_D07:     ISH_UART0_RTS_N_SNSR_HDR; currently not used */
	PAD_NC(GPP_D07, NONE),
	/* GPP_D08:     ISH_UART0_CTS_N_SNSR_HDR; currently not used */
	PAD_NC(GPP_D08, NONE),
	/* GPP_D09:     PI2S_MCLK_HDR; used for I2S0 */
	PAD_CFG_NF(GPP_D09, NONE, DEEP, NF2),
	/* GPP_D10:     HDA_BCLK_I2S0_SCLK_HDR; used for I2S0 */
	PAD_CFG_NF(GPP_D10, NONE, DEEP, NF2),
	/* GPP_D11:     HDA_SYNC_I2S0_SFRM_HDR; used for I2S0 */
	PAD_CFG_NF(GPP_D11, NONE, DEEP, NF2),
	/* GPP_D12:     HDA_SDO_I2S0_TXD_HDR; used for I2S0 */
	PAD_CFG_NF(GPP_D12, NONE, DEEP, NF2),
	/* GPP_D13:     HDA_SDI0_I2S0_RXD_HDR; used for I2S0 */
	PAD_CFG_NF(GPP_D13, NONE, DEEP, NF2),
	/* GPP_D16:     DMIC_CLK_A_1_HDR; Please check if rework for header connection is in place */
	PAD_CFG_NF(GPP_D16, NONE, DEEP, NF3),
	/* GPP_D17:     DMIC_DATA1_HDR;  Please check if rework for header connection is in place */
	...
	/* THC NOTE: use GPO instead of NF; will be driven via ACPI */
	...
	/* GPP_V16:     CSE_EARLY_SW; not used by AP currently */
	PAD_NC(GPP_V16, NONE),
	/* GPP_V17:     M2_UFS_SLP; Please make sure necessary rework is in place */
