...
#define USE_SSC 1
	...
	write32(pmmio+FW_BLC,0x011d011a); // replay
	write32(pmmio+FW_BLC2,0x00000102); // replay
	write32(pmmio+_DPLL_B, DPLL_VGA_MODE_DIS | DPLLB_MODE_LVDS | 0x18046000); // replay
	read32(pmmio+LVDS); // 0x40000000 // replay
	write32(pmmio+LVDS, LVDS_ON | PLL_P1_DIVIDE_BY_TWO | DISPLAY_RATE_SELECT_FPA1 | 0xc0300300); // replay
	write32(pmmio+_DPLL_B, DPLL_VCO_ENABLE | DPLL_VGA_MODE_DIS | DPLLB_MODE_LVDS | 0x98046000); // replay
