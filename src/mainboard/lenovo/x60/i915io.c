...
{W, 1, "", PP_ON_DELAYS, ( 0xffff0000 &0x1900000)|( 0xffff &0x7d0)|0x019007d0, 0},
{W, 1, "", PP_OFF_DELAYS, ( 0xffff0000 &0x15e0000)|( 0xffff &0x7d0)|0x015e07d0, 0},
...
{M, 1, "vgaarb:device changed decodes:PCI:0000:00:02.0,olddecodes=io+0xmem,decodes=io+0xmem:owns=io+0xmem", 0x0, 0x0, 0},
...
#if 0
{W, 1, "", _DSPACNTR,  DISPPLANE_GAMMA_ENABLE |( DISPPLANE_SEL_PIPE(0,1) &0x1000000)|0x41000000, 0},
{R, 1, "", _DSPACNTR,  DISPPLANE_GAMMA_ENABLE |( DISPPLANE_SEL_PIPE(0,1) &0x1000000)|0x41000000, 0},
{W, 1, "", _DSPACNTR,  DISPPLANE_GAMMA_ENABLE | DISPPLANE_8BPP | DISPPLANE_15_16BPP |( DISPPLANE_SEL_PIPE(0,1) &0x1000000)|0x59000000, 0},
#endif
...
#if 0
{R, 1, "", _DSPACNTR,  DISPPLANE_GAMMA_ENABLE | DISPPLANE_8BPP | DISPPLANE_15_16BPP |( DISPPLANE_SEL_PIPE(0,1) &0x1000000)|0x59000000, 0},
{W, 1, "", _DSPACNTR,  DISPLAY_PLANE_ENABLE | DISPPLANE_GAMMA_ENABLE | DISPPLANE_8BPP | DISPPLANE_15_16BPP |( DISPPLANE_SEL_PIPE(0,1) &0x1000000)|0xd9000000, 0},
#endif
