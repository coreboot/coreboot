 ...
 * by uploading a Selfboot Patch to the A55E's shadow ROM area. The patch itself
 * supports the Micrel KSZ9021 PHY that was used on LiPPERT CFR-AF revision 0v0,
 * now it serves mainly to document Broadcom's proprietary Selfboot Patch format.
 *
