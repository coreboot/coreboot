...
static const struct pad_config gpio_table[] = {
	...
	/* GPP_A1 - LAD0 */
	PAD_CFG_NF_BUF_TRIG(GPP_A1, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_A2 - LAD1 */
	PAD_CFG_NF_BUF_TRIG(GPP_A2, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_A3 - LAD2 */
	PAD_CFG_NF_BUF_TRIG(GPP_A3, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_A4 - LAD3 */
	PAD_CFG_NF_BUF_TRIG(GPP_A4, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_A5 - LFRAME# */
	PAD_CFG_NF_BUF_TRIG(GPP_A5, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_A6 - SERIRQ */
	PAD_CFG_NF_BUF_TRIG(GPP_A6, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_A7 - PIRQA# */
	PAD_CFG_NF_BUF_TRIG(GPP_A7, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_A8 - CLKRUN# */
	PAD_CFG_NF_BUF_TRIG(GPP_A8, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_A9 - CLKOUT_LPC0 */
	PAD_CFG_NF_BUF_TRIG(GPP_A9, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_A10 - GPIO */
	...
	/* ------- GPIO Group GPP_B ------- */
	/* GPP_B0 - CORE_VID0 */
	PAD_CFG_NF_BUF_TRIG(GPP_B0, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_B1 - CORE_VID1 */
	PAD_CFG_NF_BUF_TRIG(GPP_B1, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_B2 - GPIO */
	...
	/* GPP_B14 - SPKR */
	PAD_CFG_NF_BUF_TRIG(GPP_B14, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_B15 - GPIO */
	...
	/* GPP_F10 - SATA_SCLOCK */
	PAD_CFG_NF_BUF_TRIG(GPP_F10, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_F11 - SATA_SLOAD */
	PAD_CFG_NF_BUF_TRIG(GPP_F11, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_F12 - GPIO */
	PAD_CFG_GPI_TRIG_OWN(GPP_F12, NONE, DEEP, OFF, DRIVER),
	/* GPP_F13 - SATA_SDATAOUT2 */
	PAD_CFG_NF_BUF_TRIG(GPP_F13, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_F14 - SSATA_LED# */
	PAD_CFG_NF_BUF_TRIG(GPP_F14, NONE, DEEP, NF3, RX_DISABLE, OFF),
	/* GPP_F15 - GPIO */
	...
	/* GPP_F19 - LAN_SMBCLK */
	PAD_CFG_NF_BUF_TRIG(GPP_F19, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_F20 - LAN_SMBDATA */
	PAD_CFG_NF_BUF_TRIG(GPP_F20, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_F21 - LAN_SMBALRT# */
	PAD_CFG_NF_BUF_TRIG(GPP_F21, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_F22 - SSATA_SCLOCK */
	PAD_CFG_NF_BUF_TRIG(GPP_F22, NONE, DEEP, NF3, RX_DISABLE, OFF),
	/* GPP_F23 - SSATA_SLOAD */
	PAD_CFG_NF_BUF_TRIG(GPP_F23, NONE, DEEP, NF3, RX_DISABLE, OFF),
	...
	/* GPP_C1 - RESERVED */
	/* GPP_C2 - SMBALERT# */
	PAD_CFG_NF_BUF_TRIG(GPP_C2, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_C3 - RESERVED */
	/* GPP_C4 - RESERVED */
	/* GPP_C5 - GPIO */
	...
	PAD_CFG_NF_BUF_TRIG(GPP_D15, NONE, DEEP, NF3, RX_DISABLE, OFF),
	/* GPP_D16 - GPIO */
	...
	/* GPP_E3 - CPU_GP0 */
	PAD_CFG_NF_BUF_TRIG(GPP_E3, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_E4 - GPIO */
	...
	/* GPP_E8 - SATA_LED# */
	PAD_CFG_NF_BUF_TRIG(GPP_E8, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_E9 - USB_OC0# */
	...
	/* GPD11 - GBEPHY */
	PAD_CFG_NF_BUF_TRIG(GPD11, NONE, RSMRST, NF1, TX_DISABLE, OFF),

	/* ------- GPIO Community 3 ------- */
	/* ------- GPIO Group GPP_I ------- */
	/* GPP_I0 - LAN_TDO */
	PAD_CFG_NF_BUF_TRIG(GPP_I0, NONE, DEEP, NF2, TX_DISABLE, OFF),
	/* GPP_I1 - LAN_TCK */
	PAD_CFG_NF_BUF_TRIG(GPP_I1, NONE, DEEP, NF2, RX_DISABLE, OFF),
	/* GPP_I2 - LAN_TMS */
	PAD_CFG_NF_BUF_TRIG(GPP_I2, NONE, DEEP, NF2, RX_DISABLE, OFF),
	/* GPP_I3 - LAN_TDI */
	PAD_CFG_NF_BUF_TRIG(GPP_I3, NONE, DEEP, NF2, RX_DISABLE, OFF),
	/* GPP_I4 - GPIO */
	...
	/* GPP_I7 - LAN_TRST_IN */
	PAD_CFG_NF_BUF_TRIG(GPP_I7, NONE, DEEP, NF2, TX_DISABLE, OFF),
	/* GPP_I8 - GPIO */
	...
	/* ------- GPIO Group GPP_J ------- */
	/* GPP_J0 - LAN_LED_P0_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J0, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J1 - LAN_LED_P0_1 */
	PAD_CFG_NF_BUF_TRIG(GPP_J1, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J2 - LAN_LED_P1_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J2, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J3 - LAN_LED_P1_1 */
	PAD_CFG_NF_BUF_TRIG(GPP_J3, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J4 - LAN_LED_P2_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J4, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J5 - LAN_LED_P2_1 */
	PAD_CFG_NF_BUF_TRIG(GPP_J5, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J6 - LAN_LED_P3_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J6, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J7 - LAN_LED_P3_1 */
	PAD_CFG_NF_BUF_TRIG(GPP_J7, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J8 - LAN_I2C_SCL_MDC_P0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J8, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J9 - LAN_I2C_SDA_MDIO_P0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J9, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_J10 - LAN_I2C_SCL_MDC_P1 */
	PAD_CFG_NF_BUF_TRIG(GPP_J10, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J11 - LAN_I2C_SDA_MDIO_P1 */
	PAD_CFG_NF_BUF_TRIG(GPP_J11, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_J12 - LAN_I2C_SCL_MDC_P2 */
	PAD_CFG_NF_BUF_TRIG(GPP_J12, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J13 - LAN_I2C_SDA_MDIO_P2 */
	PAD_CFG_NF_BUF_TRIG(GPP_J13, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_J14 - LAN_I2C_SCL_MDC_P3 */
	PAD_CFG_NF_BUF_TRIG(GPP_J14, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_J15 - LAN_I2C_SDA_MDIO_P3 */
	PAD_CFG_NF_BUF_TRIG(GPP_J15, NONE, DEEP, NF1, NO_DISABLE, OFF),
	/* GPP_J16 - LAN_SDP_P0_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J16, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_J17 - GPIO */
	PAD_CFG_GPI_TRIG_OWN(GPP_J17, NONE, DEEP, OFF, DRIVER),
	/* GPP_J18 - LAN_SDP_P1_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J18, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_J19 - GPIO */
	PAD_CFG_GPI_TRIG_OWN(GPP_J19, NONE, DEEP, OFF, DRIVER),
	/* GPP_J20 - LAN_SDP_P2_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J20, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_J21 - GPIO */
	PAD_CFG_GPI_TRIG_OWN(GPP_J21, NONE, DEEP, OFF, DRIVER),
	/* GPP_J22 - LAN_SDP_P3_0 */
	PAD_CFG_NF_BUF_TRIG(GPP_J22, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_J23 - GPIO */
	...
	/* GPP_K7 - RESERVED */
	PAD_CFG_NF_BUF_TRIG(GPP_K7, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_K8 - LAN_NCSI_ARB_IN */
	PAD_CFG_NF_BUF_TRIG(GPP_K8, NONE, DEEP, NF1, TX_DISABLE, OFF),
	/* GPP_K9 - LAN_NCSI_ARB_OUT */
	PAD_CFG_NF_BUF_TRIG(GPP_K9, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_K10 - PE_RST# */
	PAD_CFG_NF_BUF_TRIG(GPP_K10, NONE, DEEP, NF1, TX_DISABLE, OFF),
	...
	/* GPP_G18 - NMI# */
	PAD_CFG_NF_BUF_TRIG(GPP_G18, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_G19 - SMI# */
	PAD_CFG_NF_BUF_TRIG(GPP_G19, NONE, DEEP, NF1, RX_DISABLE, OFF),
	/* GPP_G20 - RESERVED */
	/* GPP_G21 - GPIO */
