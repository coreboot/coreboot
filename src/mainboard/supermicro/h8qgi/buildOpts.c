...
CONST PSO_ENTRY ROMDATA DefaultPlatformMemoryConfiguration[] = {
	...
	//
#if 0//CONFIG_CPU_AMD_AGESA_FAMILY10
	/* Specifies the write leveling seed for a channel of a socket.
	 * WRITE_LEVELING_SEED(SocketID, ChannelID, Byte0Seed, Byte1Seed,
	 *                     Byte2Seed, Byte3Seed, Byte4Seed, Byte5Seed,
	 *                     Byte6Seed, Byte7Seed, ByteEccSeed)
	 */
	WRITE_LEVELING_SEED(
			ANY_SOCKET, ANY_CHANNEL, F10_WL_SEED, F10_WL_SEED,
			F10_WL_SEED, F10_WL_SEED, F10_WL_SEED, F10_WL_SEED,
			F10_WL_SEED, F10_WL_SEED, F10_WL_SEED),
#endif

#if 0 //CONFIG_CPU_AMD_AGESA_FAMILY15
	/* Specifies the write leveling seed for a channel of a socket.
