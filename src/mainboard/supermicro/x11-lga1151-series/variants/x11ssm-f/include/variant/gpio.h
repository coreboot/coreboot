...
static const struct pad_config gpio_table[] = {
	...
	_PAD_CFG_STRUCT(GPP_A0,
		PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
	...
	_PAD_CFG_STRUCT(GPP_A12,
		PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_B4,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | 1,
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_B6,
		PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | 1,
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_B14,
		PAD_FUNC(NF1) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_B23,
		PAD_FUNC(NF2) | PAD_RESET(DEEP) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_D2,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(EDGE_SINGLE) | PAD_IRQ_ROUTE(NMI) | PAD_BUF(TX_DISABLE),
		PAD_PULL(20K_PU)),
	...
	_PAD_CFG_STRUCT(GPP_D22,
		PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_E6,
		PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_TRIG(EDGE_SINGLE) | PAD_IRQ_ROUTE(NMI) | PAD_BUF(TX_DISABLE),
		PAD_PULL(20K_PU)),
	...
	_PAD_CFG_STRUCT(GPP_F23,
		PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	/* GPP_G8 - GPIO */
	/* PAD_NC(GPP_G8, NONE), */
	_PAD_CFG_STRUCT(GPP_G8,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),

	/* GPP_G9 - GPIO */
	/* PAD_NC(GPP_G9, NONE), */
	_PAD_CFG_STRUCT(GPP_G9,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),

	/* GPP_G10 - GPIO */
	/* PAD_NC(GPP_G10, NONE), */
	_PAD_CFG_STRUCT(GPP_G10,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),

	/* GPP_G11 - GPIO */
	/* PAD_NC(GPP_G11, NONE), */
	_PAD_CFG_STRUCT(GPP_G11,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	/* GPP_G22 - GPIO */
	/* PAD_NC(GPP_G22, NONE), */
	_PAD_CFG_STRUCT(GPP_G22,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_G23 - GPIO */
	/* PAD_NC(GPP_G23, NONE), */
	_PAD_CFG_STRUCT(GPP_G23,
		PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPP_H1,
		PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | 1,
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPD0,
		PAD_FUNC(GPIO) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPD2,
		PAD_FUNC(NF1) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE),
		PAD_CFG_OWN_GPIO(DRIVER)),
	...
	_PAD_CFG_STRUCT(GPD7,
		PAD_FUNC(GPIO) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | 1,
		PAD_CFG_OWN_GPIO(DRIVER)),
