...
void *smp_write_config_table(void *v, unsigned long * processor_map)
{
	...
	/* USB */
        smp_write_intsrc(mc, mp_INT,    MP_IRQ_TRIGGER_LEVEL|MP_IRQ_POLARITY_LOW,
                0x02, (0x00<<2)|0, apic, 0x13); 
	/* Slot 6 */
        smp_write_intsrc(mc, mp_INT,    MP_IRQ_TRIGGER_LEVEL|MP_IRQ_POLARITY_LOW,
                0x02, (0x07<<2)|0, apic, 0x13);
	...
	smp_write_address_space(mc, 0x00, ADDRESS_TYPE_MEM,      0x40000000, 0x00000000, 0xb6300000, 0x00000000);
	smp_write_address_space(mc, 0x00, ADDRESS_TYPE_PREFETCH, 0xf6300000, 0x00000000, 0x05d00000, 0x00000000);
