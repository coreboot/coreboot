/* PCI: Interrupt Routing Table found at 0x4011cee0 size = 256 */
...
const struct irq_routing_table intel_irq_routing_table = {
	...
	0x0100,     /* u16 version   */
	256,        /* u16 Table size 32+(16*devices)  */
	0x00,       /* u8 Bus 0 */
	...
	0xf1,   /*  u8 checksum - mod 256 checksum must give zero */
	{  /* bus, devfn, {link, bitmap}, {link, bitmap}, {link, bitmap}, {link, bitmap}, slot, rfu  */
	    {0x00, 0x40, {{0x01, 0xdef8}, {0x02, 0xdef8}, {0x03, 0xdef8}, {0x04, 0xdef8}}, 0x01,  0x00},
	    {0x00, 0x48, {{0x02, 0xdef8}, {0x03, 0xdef8}, {0x01, 0xdef8}, {0x02, 0xdef8}}, 0x02,  0x00},
	    {0x00, 0x50, {{0x01, 0xdef8}, {0x02, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}}, 0x00,  0x00},
	    {0x00, 0x58, {{0x04, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}}, 0x00,  0x00},
	    ...
	    {0x01, 0x28, {{0x02, 0xdef8}, {0x03, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}}, 0x0d,  0x00},
	    ...
	    {0x02, 0x38, {{0x02, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}}, 0x00,  0x00},
	    {0x02, 0x40, {{0x03, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}, {0x00, 0xdef8}}, 0x00,  0x00}
	}
};
