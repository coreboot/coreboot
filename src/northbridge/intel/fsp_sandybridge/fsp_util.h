...
#else /* (NOT) IS_ENABLED(CONFIG_HAVE_FSP_BIN) */

#define fsp_early_init(x) do {} while (0)
#define FspNotify(x) do {} while (0)
#define romstage_main_continue(x,y) do {} while (0)
#define print_hob_type_structure(x,y,z) do {} while (0)
#define romstage_fsp_rt_buffer_callback(x) do {} while (0)
#define print_fsp_info() do {} while (0)

#endif	/* IS_ENABLED(CONFIG_HAVE_FSP_BIN) */
