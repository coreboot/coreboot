...
{
	u32 pci_tolm, vx900_tom, tomk, vx900_tolm, full_tolmk, fbufk, tolmk;
	...
	vx900_tom = pci_read_config16(mcu, 0x88) & 0x07ff;
	tomk = vx900_tom << (24 - 10);
	...
	////if (tomk > tolmk)
	////	ram_resource(dev, idx++, 1<<22, tomk - (1 << 22));
