...
/* PCIe USB4 Bridge device 1 with up to 3 ports */
#define PCIE_USB4_BRIDGE_1_DEV	0x1

#define PCIE_USB4_1_0_FUNC	1
#define PCIE_USB4_1_0_DEVFN	PCI_DEVFN(PCIE_USB4_BRIDGE_1_DEV, PCIE_USB4_1_0_FUNC)
#define SOC_USB4_1_0_DEV	_SOC_DEV(PCIE_USB4_BRIDGE_1_DEV, PCIE_USB4_1_0_FUNC)

#define PCIE_USB4_1_1_FUNC	2
#define PCIE_USB4_1_1_DEVFN	PCI_DEVFN(PCIE_USB4_BRIDGE_1_DEV, PCIE_USB4_1_1_FUNC)
#define SOC_USB4_1_1_DEV	_SOC_DEV(PCIE_USB4_BRIDGE_1_DEV, PCIE_USB4_1_1_FUNC)

#define PCIE_USB4_1_2_FUNC	3
#define PCIE_USB4_1_2_DEVFN	PCI_DEVFN(PCIE_USB4_BRIDGE_1_DEV, PCIE_USB4_1_2_FUNC)
#define SOC_USB4_1_2_DEV	_SOC_DEV(PCIE_USB4_BRIDGE_1_DEV, PCIE_USB4_1_2_FUNC)
...
/* PCIe GPP Bridge device 3 with up to 6 ports */
#define PCIE_GPP_BRIDGE_3_DEV	0x3

#define PCIE_GPP_3_0_FUNC	1
#define PCIE_GPP_3_0_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_0_FUNC)
#define SOC_GPP_3_0_DEV		_SOC_DEV(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_0_FUNC)

#define PCIE_GPP_3_1_FUNC	2
#define PCIE_GPP_3_1_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_1_FUNC)
#define SOC_GPP_3_1_DEV		_SOC_DEV(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_1_FUNC)

#define PCIE_GPP_3_2_FUNC	3
#define PCIE_GPP_3_2_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_2_FUNC)
#define SOC_GPP_3_2_DEV		_SOC_DEV(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_2_FUNC)

#define PCIE_GPP_3_3_FUNC	4
#define PCIE_GPP_3_3_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_3_FUNC)
#define SOC_GPP_3_3_DEV		_SOC_DEV(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_3_FUNC)

#define PCIE_GPP_3_4_FUNC	5
#define PCIE_GPP_3_4_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_4_FUNC)
#define SOC_GPP_3_4_DEV		_SOC_DEV(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_4_FUNC)

#define PCIE_GPP_3_5_FUNC	6
#define PCIE_GPP_3_5_DEVFN	PCI_DEVFN(PCIE_GPP_BRIDGE_3_DEV, PCIE_GPP_3_5_FUNC)
...
#define NPU_DEV			0x0
#define NPU_FUNC		1
#define NPU_DEVFN		PCI_DEVFN(NPU_DEV, NPU_FUNC)
...
#define   USB4_ROUTER_0_DEV	0x0
#define   USB4_ROUTER_0_FUNC	5
#define   USB4_ROUTER_0_DEVFN	PCI_DEVFN(USB4_ROUTER_0_DEV, USB4_ROUTER_0_FUNC)

#define   USB4_ROUTER_1_DEV	0x0
#define   USB4_ROUTER_1_FUNC	6
#define   USB4_ROUTER_1_DEVFN	PCI_DEVFN(USB4_ROUTER_1_DEV, USB4_ROUTER_1_FUNC)
