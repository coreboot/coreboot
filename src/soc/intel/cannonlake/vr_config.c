...
VR_CONFIG_TDC(PCI_DID_INTEL_WHL_ID_W_4) {
	{  0, value_not_set, VR_CFG_ALL_DOMAINS_TDC(4, 48, 22, 22) },
};
VR_CONFIG_TDC(PCI_DID_INTEL_WHL_ID_W_2) {
	{  0, value_not_set, VR_CFG_ALL_DOMAINS_TDC(4, 24, 22, 22) },
};
...
static const struct vr_lookup vr_config_tdc[] = {
	...
	VR_REFITEM_TDC(PCI_DID_INTEL_WHL_ID_W_4),
	VR_REFITEM_TDC(PCI_DID_INTEL_WHL_ID_W_2),
