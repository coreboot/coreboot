...
/*
 * Common finalize implementation for Intel SoCs.
 * This consolidates the nearly identical finalize.c implementations
 * across Meteor Lake and Panther Lake platforms.
 */
