...
enum {
	...
	MIPITX1_BASE		= IO_PHYS + 0x030C0000,
	...
	DISP_PWM_BASE		= IO_PHYS + 0x060B0000,
	...
	DISP_CCORR2_BASE	= IO_PHYS + 0x220B0000,
	DISP_CCORR3_BASE	= IO_PHYS + 0x220C0000,
	DISP_COLOR0_BASE	= IO_PHYS + 0x220F0000,
	DISP_DITHER0_BASE	= IO_PHYS + 0x22110000,
	DISP_DITHER1_BASE	= IO_PHYS + 0x22120000,
	DISP_GAMMA0_BASE	= IO_PHYS + 0x22130000,
	DISP_GAMMA1_BASE	= IO_PHYS + 0x22140000,
	DISP_POSTMASK0_BASE	= IO_PHYS + 0x22180000,
	DISP_POSTMASK1_BASE	= IO_PHYS + 0x22190000,
	DISP_MDP_RSZ0_BASE	= IO_PHYS + 0x221A0000,
	DISP_MDP_RSZ1_BASE	= IO_PHYS + 0x221B0000,
	DISP_TDSHP0_BASE	= IO_PHYS + 0x221E0000,
	DISP_TDSHP1_BASE	= IO_PHYS + 0x221F0000,
	MMSYS1_CONFIG_BASE	= IO_PHYS + 0x22400000,
	MMSYS1_MUTEX_BASE	= IO_PHYS + 0x22420000,
	DSC2_BASE		= IO_PHYS + 0x22470000,
	DSC3_BASE		= IO_PHYS + 0x22480000,
	DSI0_BASE		= IO_PHYS + 0x22490000,
	DSI1_BASE		= IO_PHYS + 0x224A0000,
	...
	OVLSYS_EXDMA6_BASE	= IO_PHYS + 0x22890000,
	...
	OVLSYS_BLENDER5_BASE	= IO_PHYS + 0x22920000,
	OVLSYS_BLENDER6_BASE	= IO_PHYS + 0x22930000,
	OVLSYS_BLENDER7_BASE	= IO_PHYS + 0x22940000,
	OVLSYS_BLENDER8_BASE	= IO_PHYS + 0x22950000,
	OVLSYS_OUTPROC0_BASE	= IO_PHYS + 0x22970000,
	OVLSYS_OUTPROC1_BASE	= IO_PHYS + 0x22980000,
	OVLSYS1_CONFIG_BASE	= IO_PHYS + 0x22C00000,
	OVLSYS1_MUTEX_BASE	= IO_PHYS + 0x22C20000,
	OVLSYS1_EXDMA2_BASE	= IO_PHYS + 0x22C50000,
	OVLSYS1_BLENDER1_BASE	= IO_PHYS + 0x22CE0000,
	OVLSYS1_BLENDER2_BASE	= IO_PHYS + 0x22CF0000,
	OVLSYS1_BLENDER3_BASE	= IO_PHYS + 0x22D00000,
	OVLSYS1_BLENDER4_BASE	= IO_PHYS + 0x22D10000,
	OVLSYS1_OUTPROC0_BASE	= IO_PHYS + 0x22D70000,
