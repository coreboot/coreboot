...
#define DISP_PLL0_BASE			0xAF00000
#define DISP_PLL1_BASE			0xAF01000
#define DISP_CC_BASE			0xAF08000

#define TCSR_GCC_EDP_CLKREF_EN_ADDR      ((void *)0x1FD5060)
...
#define AOP_BOOT_COOKIE_ADDR		0xC30F040
#define RPMH_BASE			0x18920000
...
/* HS USB MP PHY base addresses */
#define HS_USB_MP0_PHY_BASE		0x00FA1000
#define HS_USB_MP1_PHY_BASE		0x00FA2000
#define QMP_PHY_MP0_QSERDES_COM_REG_BASE	0x00FA3000
#define QMP_PHY_MP0_QSERDES_TX_REG_BASE		0x00FA3E00
#define QMP_PHY_MP0_QSERDES_RX_REG_BASE		0x00FA4000
#define QMP_PHY_MP0_PCS_REG_BASE		0x00FA3400
#define QMP_PHY_MP0_PCS_USB3_REG_BASE		0x00FA4200
#define USB_HOST_DWC3_MP_BASE			0x0A40C100

#define QMP_PHY_MP1_QSERDES_COM_REG_BASE	0x00FA5000
#define QMP_PHY_MP1_QSERDES_TX_REG_BASE		0x00FA5E00
#define QMP_PHY_MP1_QSERDES_RX_REG_BASE		0x00FA6000
#define QMP_PHY_MP1_PCS_REG_BASE		0x00FA5400
#define QMP_PHY_MP1_PCS_USB3_REG_BASE		0x00FA6200

/* TCSR QREFS CXO repeater/receiver config registers */
#define TCSR_QREFS_CXO_1_RPT0_CONFIG_ADDR	((void *)(TCSR_BASE + 0x95000))
#define TCSR_QREFS_CXO_RX5_CONFIG_ADDR		((void *)(TCSR_BASE + 0x95008))
#define TCSR_QREFS_CXO_RPT1_CONFIG_ADDR	((void *)(TCSR_BASE + 0x9501C))
#define TCSR_QREFS_CXO_RX1_CONFIG_ADDR		((void *)(TCSR_BASE + 0x95038))

/* TCSR USB MP reference clock enable registers */
#define TCSR_GCC_USB3_MP0_CLKREF_EN_ADDR	((void *)(TCSR_BASE + 0x95064))
#define TCSR_GCC_USB3_MP1_CLKREF_EN_ADDR	((void *)(TCSR_BASE + 0x95068))
#define TCSR_GCC_USB2_2_CLKREF_EN_ADDR		((void *)(TCSR_BASE + 0x95070))
