...
#define QMP_PHY_INIT_DELAY_US	100
#define QMP_PHY_STATUS_TIMEOUT_US	10000

/* QSERDES COM register layout */
...
struct usb3_phy_pcs_reg_layout {
	...
	u8 _reserved10[12];	/* covers PCS_TX_RX_CONFIG2, PCS_RX_IDLE_DTCT_CNTRL, PCS_RX_DCC_CAL_CONFIG */
	u32 pcs_eq_config1;
	u8 _reserved11[12];
	u32 pcs_eq_config5;
};
...
check_member(usb3_phy_pcs_reg_layout, pcs_eq_config1, 0x1e0);
check_member(usb3_phy_pcs_reg_layout, pcs_eq_config5, 0x1f0);

struct usb3_phy_pcs_usb3_reg_layout {
	u32 reserved[6];				/* 0x00-0x17 */
	u32 pcs_usb3_lfps_det_high_count_val;		/* 0x18 */
	u32 reserved1[7];				/* 0x1C-0x37 */
	u32 pcs_usb3_rxeqtraining_wait_time_s2;		/* 0x38 */
...
static const qmp_phy_init_tbl_t qmp_v4_usb3_serdes_tbl[] = {
	...
	{(u32)offsetof(struct usb3_phy_qserdes_com_reg_layout, com_dec_start_msb_mode1), 0x00},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_com_reg_layout, com_dec_start_msb_mode0), 0x00},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_com_reg_layout, com_sysclk_buf_enable), 0x0c},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_com_reg_layout, com_auto_gain_adj_ctrl_2), 0x4a},
	{(u32)offsetof(struct usb3_phy_qserdes_com_reg_layout, com_auto_gain_adj_ctrl_3), 0x36},
...
static const qmp_phy_init_tbl_t qmp_v4_usb3_tx_tbl[] = {
	...
	{(u32)offsetof(struct usb3_phy_qserdes_tx_reg_layout, tx_lane_mode_3), 0x11},
	{(u32)offsetof(struct usb3_phy_qserdes_tx_reg_layout, tx_lane_mode_4), 0x30},
...
static const qmp_phy_init_tbl_t qmp_v4_usb3_rx_tbl[] = {
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_ucdr_fo_gain), 0x0b},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_ucdr_so_gain), 0x04},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_aux_data_tcoarse_tfine), 0x20},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_gm_cal), 0x1c},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_equ_adaptor_cntrl2), 0x0e},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_eq_offset_adaptor_cntrl1), 0x27},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_sigdet_enables), 0x0c},
	...
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_00_low), 0xbf},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_00_high), 0xbf},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_00_high2), 0xbf},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_00_high3), 0xdf},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_00_high4), 0xeb},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_01_low), 0x19},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_01_high), 0x09},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_01_high2), 0x91},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_01_high3), 0xb7},
	{(u32)offsetof(struct usb3_phy_qserdes_rx_reg_layout, rx_rx_mode_01_high4), 0xaa},
...
static const qmp_phy_init_tbl_t qmp_v4_usb3_pcs_usb3_tbl[] = {
	...
	{(u32)offsetof(struct usb3_phy_pcs_usb3_reg_layout, pcs_usb3_rxeqtraining_wait_time_s2), 0x75},
...
/* Write register init table to the given base address */
...
{
	bool ret = true;
	struct usb3_phy_pcs_reg_layout *current_pcs_reg =
		(struct usb3_phy_pcs_reg_layout *)ss_phy_reg->pcs_base;
	...
	udelay(QMP_PHY_INIT_DELAY_US);

	/* Deassert SW reset and start PCS/Serdes */
	 ...
	 */
	long lock_us = wait_us(QMP_PHY_STATUS_TIMEOUT_US,
			!(read32(&current_pcs_reg->pcs_pcs_status1)&
			USB3_PCS_PHYSTATUS));

	u32 cmn_status  = read32((void *)((uintptr_t)ss_phy_reg->com_base + 0x2C8));
	u32 pcs_status1 = read32(&current_pcs_reg->pcs_pcs_status1);

	if (!lock_us) {
		ret = false;
		printk(BIOS_ERR, "QMP PHY %s PLL LOCK failed: CMN_STATUS=0x%08x PCS_STATUS1=0x%08x\n",
		       ss_phy_reg->name, cmn_status, pcs_status1);
	} else {
		printk(BIOS_DEBUG, "QMP PHY %s locked in %ldus: CMN_STATUS=0x%08x PCS_STATUS1=0x%08x\n",
		       ss_phy_reg->name, lock_us, cmn_status, pcs_status1);
	}
	return ret;
}
