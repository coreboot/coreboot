...
DECLARE_REGION(dram_oob_nc)
DECLARE_REGION(dram_oob)
DECLARE_REGION(dram_oob_non_secure)
DECLARE_REGION(dram_spss)
DECLARE_REGION(dram_soccp)
DECLARE_REGION(dram_soccp_dtb)
DECLARE_REGION(dram_soccp_meta)
DECLARE_REGION(dram_soccp_dtb_meta)
