...
/* PMIC IDs */
#define PMIC_A_SLAVE_ID			0x00 // PMK8380A
#define PMIC_B_SLAVE_ID			0x01 // PMC8380C
#define PMIC_C_SLAVE_ID			0x02 // PMC8380VE
#define PMIC_D_SLAVE_ID			0x03 // PMC8380VE
#define PMIC_E_SLAVE_ID			0x04 // PMC8380
#define PMIC_F_SLAVE_ID			0x05 // PMC8380VE
#define PMIC_I_SLAVE_ID			0x08 // PMC8380VE
#define PMIC_J_SLAVE_ID			0x09 // PMC8380VE
...
#define TCSR_GCC_EDP_CLKREF_EN_ADDR		((void *)0x1FD5130)
...
enum {
	...
	VBIF_NRT_BASE			= MDSS_BASE + 0xB8000,
	...
	MDP_PERIPH_TOP1			= MDSS_BASE + 0x00013F0,
};

#define SOC_BOOT_CONFIG			0x221C8600
