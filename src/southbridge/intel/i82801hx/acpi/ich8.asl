...
/* Intel 82801Hx (ICH8) support */

Scope(\)
{
	// IO Trap at 0x800. SMI function in SMIF NVS variable.
	...
	// ICH8 Power Management Registers, located at PMBASE (0x1f.0 0x40.l)
	...
	// ICH8 GPIO IO mapped registers (0x1f.0 reg 0x48.l)
	...
	// ICH8 Root Complex Register Block. Memory Mapped through RCBA)
