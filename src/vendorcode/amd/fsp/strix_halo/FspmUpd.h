...
typedef struct __packed {
	...
	/** Offset 0x04FA**/	uint8_t                       xgbe_disable;
	...
	/** Offset 0x050A**/	uint8_t                       enable_fixed_preset;
	/** Offset 0x050B**/	uint8_t                       pcie_gen3_fixed_preset_value;
	/** Offset 0x050C**/	uint8_t                       pcie_gen4_fixed_preset_value;
	/** Offset 0x050D**/	uint8_t                       UnusedUpdSpace2[243];
...
#define IMAGE_REVISION_REVISION 0x01
