...
#define DDRPHY_REG_B0_PHY4                                     (DDRPHY_AO_BASE_ADDRESS + 0x01B0)
    #define B0_PHY4_RG_ARPI_SUM_MON_SEL_B0                     Fld(3, 0) //[2:0]
    #define B0_PHY4_RG_RX_ARDQ_INB_BIAS_SEL_B0                 Fld(1, 4) //[4:4]
...
#define DDRPHY_REG_B1_PHY4                                     (DDRPHY_AO_BASE_ADDRESS + 0x0330)
    #define B1_PHY4_RG_ARPI_SUM_MON_SEL_B1                     Fld(3, 0) //[2:0]
    #define B1_PHY4_RG_RX_ARDQ_INB_BIAS_SEL_B1                 Fld(1, 4) //[4:4]

#define DDRPHY_REG_B1_TX_CKE_CTRL                              (DDRPHY_AO_BASE_ADDRESS + 0x0334)
    #define B1_TX_CKE_CTRL_RG_TX_ARCKE_OE_TIE_EN_B1            Fld(1, 0) //[0:0]
    #define B1_TX_CKE_CTRL_RG_TX_ARCKE_OE_TIE_SEL_B1           Fld(1, 1) //[1:1]
    #define B1_TX_CKE_CTRL_RG_TX_ARCKE0_PULL_DN_B1             Fld(1, 2) //[2:2]
    #define B1_TX_CKE_CTRL_RG_TX_ARCKE0_PULL_UP_B1             Fld(1, 3) //[3:3]
    #define B1_TX_CKE_CTRL_RG_TX_ARCKE1_PULL_DN_B1             Fld(1, 4) //[4:4]
    #define B1_TX_CKE_CTRL_RG_TX_ARCKE1_PULL_UP_B1             Fld(1, 5) //[5:5]
    #define B1_TX_CKE_CTRL_RG_TX_ARCS1_OE_TIE_EN_B1            Fld(1, 6) //[6:6]
...
#define DDRPHY_REG_CA_PHY4                                     (DDRPHY_AO_BASE_ADDRESS + 0x04B0)
    #define CA_PHY4_RG_ARPI_SUM_MON_SEL_C0                     Fld(3, 0) //[2:0]
    #define CA_PHY4_RG_RX_ARCA_INB_BIAS_SEL_C0                 Fld(1, 4) //[4:4]

#define DDRPHY_REG_CA_TX_ARCS_CTRL                             (DDRPHY_AO_BASE_ADDRESS + 0x04B4)
    #define CA_TX_ARCS_CTRL_RG_TX_ARCS_OE_TIE_SEL_C0           Fld(1, 0) //[0:0]
    #define CA_TX_ARCS_CTRL_RG_TX_ARCS_PULL_DN_C0              Fld(1, 1) //[1:1]
    #define CA_TX_ARCS_CTRL_RG_TX_ARCS_PULL_UP_C0              Fld(1, 2) //[2:2]

#define DDRPHY_REG_CA_TX_ARDQ_CTRL                             (DDRPHY_AO_BASE_ADDRESS + 0x04B8)
    #define CA_TX_ARDQ_CTRL_RG_TX_ARDQ6_OE_TIE_EN_C0           Fld(1, 0) //[0:0]
    #define CA_TX_ARDQ_CTRL_RG_TX_ARDQ7_OE_TIE_EN_C0           Fld(1, 1) //[1:1]
...
#define DDRPHY_REG_SHU_B0_DQ13                                 (DDRPHY_AO_BASE_ADDRESS + 0x08B4)
    ...
    #define SHU_B0_DQ13_RG_TX_ARDQS_SER_READ_BASE_EN_B0        Fld(1, 26) //[26:26]
...
#define DDRPHY_REG_SHU_B0_LPBK_CTRL                            (DDRPHY_AO_BASE_ADDRESS + 0x08C0)
    #define SHU_B0_LPBK_CTRL_RG_RX_ART2RLPBK_DQS_SEL_B0        Fld(2, 0) //[1:0]
    #define SHU_B0_LPBK_CTRL_RG_TX_ARDQ_LPBK_SEL_B0            Fld(2, 2) //[3:2]
    #define SHU_B0_LPBK_CTRL_RG_TX_ARDQS_LPBK_EN_B0            Fld(1, 4) //[4:4]

#define DDRPHY_REG_SHU_B0_DQSIEN_CFG                           (DDRPHY_AO_BASE_ADDRESS + 0x08C4)
    #define SHU_B0_DQSIEN_CFG_RG_RX_ARDQS_DQSIEN_FORCE_ON_EN_B0 Fld(1, 0) //[0:0]
    #define SHU_B0_DQSIEN_CFG_RG_RX_ARDQS_DQSIEN_GLITCH_FREE_EN_B0 Fld(1, 1) //[1:1]
...
#define DDRPHY_REG_SHU_RK_B1_CKE_OFFSET                        (DDRPHY_AO_BASE_ADDRESS + 0x0944)
    #define SHU_RK_B1_CKE_OFFSET_RG_RX_ARCS1_OFFSETC_B1        Fld(4, 0) //[3:0]
    #define SHU_RK_B1_CKE_OFFSET_RG_RX_ARCKE0_OFFSETC_B1       Fld(4, 4) //[7:4]
    #define SHU_RK_B1_CKE_OFFSET_RG_RX_ARCKE1_OFFSETC_B1       Fld(4, 8) //[11:8]

#define DDRPHY_REG_SHU_RK_B1_CKE_DLY                           (DDRPHY_AO_BASE_ADDRESS + 0x0948)
    #define SHU_RK_B1_CKE_DLY_RG_RX_ARCS1_DLY_B1               Fld(8, 0) //[7:0]
    #define SHU_RK_B1_CKE_DLY_RG_RX_ARCKE0_DLY_B1              Fld(8, 8) //[15:8]
    #define SHU_RK_B1_CKE_DLY_RG_RX_ARCKE1_DLY_B1              Fld(8, 16) //[23:16]
...
#define DDRPHY_REG_SHU_B1_DQ13                                 (DDRPHY_AO_BASE_ADDRESS + 0x0A34)
    ...
    #define SHU_B1_DQ13_RG_TX_ARDQS_SER_READ_BASE_EN_B1        Fld(1, 26) //[26:26]
...
#define DDRPHY_REG_SHU_B1_LPBK_CTRL                            (DDRPHY_AO_BASE_ADDRESS + 0x0A40)
    #define SHU_B1_LPBK_CTRL_RG_RX_ART2RLPBK_DQS_SEL_B1        Fld(2, 0) //[1:0]
    #define SHU_B1_LPBK_CTRL_RG_TX_ARDQ_LPBK_SEL_B1            Fld(2, 2) //[3:2]
    #define SHU_B1_LPBK_CTRL_RG_TX_ARDQS_LPBK_EN_B1            Fld(1, 4) //[4:4]

#define DDRPHY_REG_SHU_B1_DQSIEN_CFG                           (DDRPHY_AO_BASE_ADDRESS + 0x0A44)
    #define SHU_B1_DQSIEN_CFG_RG_RX_ARDQS_DQSIEN_FORCE_ON_EN_B1 Fld(1, 0) //[0:0]
    #define SHU_B1_DQSIEN_CFG_RG_RX_ARDQS_DQSIEN_GLITCH_FREE_EN_B1 Fld(1, 1) //[1:1]

#define DDRPHY_REG_SHU_B1_CKE_CTRL                             (DDRPHY_AO_BASE_ADDRESS + 0x0A48)
    #define SHU_B1_CKE_CTRL_RG_TX_ARCKE_OE_ODTEN_CG_EN_B1      Fld(1, 0) //[0:0]
    #define SHU_B1_CKE_CTRL_RG_TX_ARCKE_MCKIO_SEL_B1           Fld(1, 1) //[1:1]
    #define SHU_B1_CKE_CTRL_RG_TX_ARCKE_DRVP_B1                Fld(5, 4) //[8:4]
    #define SHU_B1_CKE_CTRL_RG_TX_ARCKE_DRVN_B1                Fld(5, 12) //[16:12]

#define DDRPHY_REG_SHU_B1_CKE_DLY_CTRL                         (DDRPHY_AO_BASE_ADDRESS + 0x0A4C)
    #define SHU_B1_CKE_DLY_CTRL_RG_TX_ARCKE0_DLY_B1            Fld(8, 0) //[7:0]
    #define SHU_B1_CKE_DLY_CTRL_RG_TX_ARCKE1_DLY_B1            Fld(8, 8) //[15:8]
    #define SHU_B1_CKE_DLY_CTRL_RG_TX_ARCS1_DLY_B1             Fld(8, 16) //[23:16]
    #define SHU_B1_CKE_DLY_CTRL_RG_TX_ARCKE_DUTY_DLY_B1        Fld(6, 24) //[29:24]
...
#define DDRPHY_REG_SHU_RK_CA_DQ_OFFSET                         (DDRPHY_AO_BASE_ADDRESS + 0x0AB8)
    #define SHU_RK_CA_DQ_OFFSET_RG_RX_ARDQ6_OFFSETC_C0         Fld(4, 0) //[3:0]
    #define SHU_RK_CA_DQ_OFFSET_RG_RX_ARDQ7_OFFSETC_C0         Fld(4, 4) //[7:4]

#define DDRPHY_REG_SHU_RK_CA_DQ_DLY                            (DDRPHY_AO_BASE_ADDRESS + 0x0ABC)
    #define SHU_RK_CA_DQ_DLY_RG_RX_ARDQ6_DLY_RK0_C0            Fld(8, 0) //[7:0]
    #define SHU_RK_CA_DQ_DLY_RG_RX_ARDQ7_DLY_RK0_C0            Fld(8, 8) //[15:8]
...
#define DDRPHY_REG_SHU_CA_CMD13                                (DDRPHY_AO_BASE_ADDRESS + 0x0BB4)
    ...
    #define SHU_CA_CMD13_RG_TX_ARCLK_SER_READ_BASE_EN_C0       Fld(1, 26) //[26:26]
...
#define DDRPHY_REG_SHU_CA_LPBK_CTRL                            (DDRPHY_AO_BASE_ADDRESS + 0x0BC0)
    #define SHU_CA_LPBK_CTRL_RG_RX_ART2RLPBK_CLK_SEL_C0        Fld(2, 0) //[1:0]
    #define SHU_CA_LPBK_CTRL_RG_TX_ARCA_LPBK_SEL_C0            Fld(2, 2) //[3:2]
    #define SHU_CA_LPBK_CTRL_RG_TX_ARCLK_LPBK_EN_C0            Fld(1, 4) //[4:4]

#define DDRPHY_REG_SHU_CA_DQSIEN_CFG                           (DDRPHY_AO_BASE_ADDRESS + 0x0BC4)
    #define SHU_CA_DQSIEN_CFG_RG_RX_ARCLK_DQSIEN_GLITCH_FREE_EN_C0 Fld(1, 0) //[0:0]
    #define SHU_CA_DQSIEN_CFG_RG_RX_ARCLK_DQSIEN_FORCE_ON_EN_C0 Fld(1, 1) //[1:1]

#define DDRPHY_REG_SHU_CA_CS_CTRL                              (DDRPHY_AO_BASE_ADDRESS + 0x0BC8)
    #define SHU_CA_CS_CTRL_RG_TX_ARCS_OE_ODTEN_CG_EN_C0        Fld(1, 0) //[0:0]
    #define SHU_CA_CS_CTRL_RG_TX_ARCS_MCKIO_SEL_C0             Fld(1, 1) //[1:1]
    #define SHU_CA_CS_CTRL_RG_TX_ARCS_DRVN_C0                  Fld(5, 4) //[8:4]
    #define SHU_CA_CS_CTRL_RG_TX_ARCS_DRVP_C0                  Fld(5, 12) //[16:12]
    #define SHU_CA_CS_CTRL_RG_TX_ARCS_ODTN_C0                  Fld(5, 20) //[24:20]
    #define SHU_CA_CS_CTRL_RG_TX_ARCS_DUTY_DLY_C0              Fld(6, 25) //[30:25]

#define DDRPHY_REG_SHU_CA_DQ_DLY                               (DDRPHY_AO_BASE_ADDRESS + 0x0BCC)
    #define SHU_CA_DQ_DLY_RG_TX_ARDQ6_DLY_C0                   Fld(8, 0) //[7:0]
    #define SHU_CA_DQ_DLY_RG_TX_ARDQ7_DLY_C0                   Fld(8, 8) //[15:8]
