...
#define DDRPHY_MD32_REG_SSPM_CFGREG_SW_RSTN                    (DDRPHY_MD32_BASE_ADDRESS + 0x0000)
    ...
    #define SSPM_CFGREG_SW_RSTN_MEM_RATIO                      Fld(2, 28) //[29:28]
...
#define DDRPHY_MD32_REG_SSPM_CFGREG_MBIST_PREFUSE_0            (DDRPHY_MD32_BASE_ADDRESS + 0x01A0)
    #define SSPM_CFGREG_MBIST_PREFUSE_0_MBIST_PREFUSE_0        Fld(32, 0) //[31:0]
...
#define DDRPHY_MD32_REG_LPIF_RESERVED_16                       (DDRPHY_MD32_BASE_ADDRESS + 0x7090)
    #define LPIF_RESERVED_16_DRAMC_DPM_BACKUP_FLAG             Fld(1, 0) //[0:0]
