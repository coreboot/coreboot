...
inline static uint8_t le8_to_h(void *src)
{
	uint8_t *b = src;
	return b[0];
};
...
inline static uint8_t be8_to_h(void *src)
{
	uint8_t *b = src;
	return b[0];
};

inline static uint16_t be16_to_h(void *src)
{
	uint8_t *b = src;
	return ((b[1] << 0) | (b[0] << 16));
};

inline static uint32_t be32_to_h(void *src)
{
	uint8_t *b = src;
