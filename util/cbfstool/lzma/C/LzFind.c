...
static uint8_t MatchFinder_GetIndexuint8_t(CMatchFinder *p, int32_t bindex) { return p->buffer[bindex]; }

static uint32_t MatchFinder_GetNumAvailableuint8_ts(CMatchFinder *p) { return p->streamPos - p->pos; }
...
void MatchFinder_CreateVTable(CMatchFinder *p, IMatchFinder *vTable)
{
  ...
  vTable->GetIndexuint8_t = (Mf_GetIndexuint8_t_Func)MatchFinder_GetIndexuint8_t;
  vTable->GetNumAvailableuint8_ts = (Mf_GetNumAvailableuint8_ts_Func)MatchFinder_GetNumAvailableuint8_ts;
