...
void MatchFinder_CreateVTable(CMatchFinder *p, IMatchFinder *vTable)
{
  ...
  vTable->GetIndexuint8_t = (Mf_GetIndexByte_Func)MatchFinder_GetIndexuint8_t;
  vTable->GetNumAvailableuint8_ts = (Mf_GetNumAvailableBytes_Func)MatchFinder_GetNumAvailableuint8_ts;
