...
#define Inline_MatchFinder_GetIndexuint8_t(p, index) ((p)->buffer[(int32_t)(index)])

#define Inline_MatchFinder_GetNumAvailableuint8_ts(p) ((p)->streamPos - (p)->pos)
...
/*
Conditions:
  Mf_GetNumAvailableuint8_ts_Func must be called before each Mf_GetMatchLen_Func.
  Mf_GetPointerToCurrentPos_Func's result must be used only before any other function
*/

typedef void (*Mf_Init_Func)(void *object);
typedef uint8_t (*Mf_GetIndexuint8_t_Func)(void *object, int32_t index);
typedef uint32_t (*Mf_GetNumAvailableuint8_ts_Func)(void *object);
...
{
  Mf_Init_Func Init;
  Mf_GetIndexuint8_t_Func GetIndexuint8_t;
  Mf_GetNumAvailableuint8_ts_Func GetNumAvailableuint8_ts;
