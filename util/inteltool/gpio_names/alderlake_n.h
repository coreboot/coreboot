...
#ifndef GPIO_NAMES_ALDERLAKE_N
#define GPIO_NAMES_ALDERLAKE_N

#include "gpio_groups.h"

/* ----------------------------- Alder Lake P ----------------------------- */

const char *const alderlake_pch_n_group_a_names[] = {
...
const struct gpio_group alderlake_pch_n_group_a = {
	.display	= "------- GPIO Group GPP_A -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_a_names) / 7,
	.func_count	= 7,
	.pad_names	= alderlake_pch_n_group_a_names,
};

const char *const alderlake_pch_n_group_b_names[] = {
...
const struct gpio_group alderlake_pch_n_group_b = {
	.display	= "------- GPIO Group GPP_B -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_b_names) / 7,
	.func_count	= 7,
	.pad_names	= alderlake_pch_n_group_b_names,
};

const char *const alderlake_pch_n_group_c_names[] = {
...
const struct gpio_group alderlake_pch_n_group_c = {
	.display	= "------- GPIO Group GPP_C -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_c_names) / 7,
	.func_count	= 7,
	.pad_names	= alderlake_pch_n_group_c_names,
};

const char *const alderlake_pch_n_group_d_names[] = {
...
const struct gpio_group alderlake_pch_n_group_d = {
	.display	= "------- GPIO Group GPP_D -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_d_names) / 8,
	.func_count	= 8,
	.pad_names	= alderlake_pch_n_group_d_names,
};

const char *const alderlake_pch_n_group_e_names[] = {
...
const struct gpio_group alderlake_pch_n_group_e = {
	.display	= "------- GPIO Group GPP_E -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_e_names) / 8,
	.func_count	= 8,
	.pad_names	= alderlake_pch_n_group_e_names,
};

const char *const alderlake_pch_n_group_f_names[] = {
...
const struct gpio_group alderlake_pch_n_group_f = {
	.display	= "------- GPIO Group GPP_F -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_f_names) / 7,
	.func_count	= 7,
	.pad_names	= alderlake_pch_n_group_f_names,
};

const char *const alderlake_pch_n_group_h_names[] = {
...
const struct gpio_group alderlake_pch_n_group_h = {
	.display	= "------- GPIO Group GPP_H -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_h_names) / 7,
	.func_count	= 7,
	.pad_names	= alderlake_pch_n_group_h_names,
};

const char *const alderlake_pch_n_group_i_names[] = {
	"GPP_I0",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
	"GPP_I1",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
	"GPP_I2",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
	"GPP_I3",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
	"GPP_I4",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
	"GPP_I5",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"USB_C_GPP_I5",
	"GPP_I6",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
	"GPP_I7",	"EMMC_CMD",		    "n/a",			"n/a",			"n/a",		"n/a",		"USB_C_GPP_I7",
	"GPP_I8",	"EMMC_DATA0",		"n/a",	        "n/a",			"n/a",		"n/a",		"USB_C_GPP_I8",
	"GPP_I9",	"EMMC_DATA1",		"n/a",	        "n/a",			"n/a",		"n/a",		"USB_C_GPP_I9",
	"GPP_I10",	"EMMC_DATA2",		"n/a",		    "n/a",	        "n/a",		"n/a",		"USB_C_GPP_I10",
	"GPP_I11",	"EMMC_DATA3",		"n/a",		    "n/a",		    "n/a",		"n/a",		"USB_C_GPP_I11",
	"GPP_I12",	"EMMC_DATA4",		"n/a",		    "n/a",		    "n/a",	    "n/a",	    "USB_C_GPP_I12",
	"GPP_I13",	"EMMC_DATA5",		"n/a",		    "n/a",		    "n/a",	    "n/a",	    "USB_C_GPP_I13",
	"GPP_I14",	"EMMC_DATA6",		"n/a",			"n/a",			"n/a",		"n/a",		"USB_C_GPP_I14",
	"GPP_I15",	"EMMC_DATA7",		"n/a",			"n/a",	        "n/a",		"n/a",		"USB_C_GPP_I15",
	"GPP_I16",	"EMMC_RCLK",	    "n/a",			"n/a",			"n/a",		"n/a",		"USB_C_GPP_I16",
	"GPP_I17",	"EMMC_CLK",		    "n/a",			"n/a",			"n/a",		"n/a",		"USB_C_GPP_I17",
	"GPP_I18",	"EMMC_RESET#",	    "n/a",			"n/a",			"n/a",		"n/a",		"USB_C_GPP_I18",
	"GPP_I19",	"n/a",		        "n/a",			"n/a",			"n/a",		"n/a",		"n/a",
};

const struct gpio_group alderlake_pch_n_group_i = {
	.display	= "------- GPIO Group GPP_I -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_i_names) / 7,
	.func_count	= 7,
	.pad_names	= alderlake_pch_n_group_i_names,
};

const char *const alderlake_pch_n_group_r_names[] = {
...
const struct gpio_group alderlake_pch_n_group_r = {
	.display	= "------- GPIO Group GPP_R -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_r_names) / 5,
	.func_count	= 5,
	.pad_names	= alderlake_pch_n_group_r_names,
};

const char *const alderlake_pch_n_group_s_names[] = {
...
const struct gpio_group alderlake_pch_n_group_s = {
	.display	= "------- GPIO Group GPP_S -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_s_names) / 5,
	.func_count	= 5,
	.pad_names	= alderlake_pch_n_group_s_names,
};

const char *const alderlake_pch_n_group_t_names[] = {
	"GPP_T0",	"n/a",	"n/a",
	"GPP_T1",	"n/a",	"n/a",
	"GPP_T2",	"n/a",	"FUSA_DIAGTEST_EN",
	"GPP_T3",	"n/a",	"FUSA_DIAGTEST_MODE",
	"GPP_T4",	"n/a",	"n/a",
	"GPP_T5",	"n/a",	"n/a",
	"GPP_T6",	"n/a",	"n/a",
	"GPP_T7",	"n/a",	"n/a",
...
const struct gpio_group alderlake_pch_n_group_t = {
	.display	= "------- GPIO Group GPP_T -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_t_names) / 3,
	.func_count	= 3,
	.pad_names	= alderlake_pch_n_group_t_names,
};

const char *const alderlake_pch_n_group_gpd_names[] = {
	"GPD0",			"BATLOW#",
	"GPD1",			"ACPRESENT",
	"GPD2",			"LAN_WAKE#",
	"GPD3",			"PWRBTN#",
...
const struct gpio_group alderlake_pch_n_group_gpd = {
	.display	= "------- GPIO Group GPP_GPD -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_gpd_names) / 2,
	.func_count	= 2,
	.pad_names	= alderlake_pch_n_group_gpd_names,
};

const char *const alderlake_pch_n_group_hvcmos_names[] = {
	"GPP_L_BKLTEN",		"n/a",
	"GPP_L_BKLTCTL",	"n/a",
	"GPP_L_VDDEN",		"n/a",
	"GPP_SYS_PWROK",	"n/a",
...
const struct gpio_group alderlake_pch_n_group_hvcmos = {
	.display	= "------- GPIO Group GPP_HVCMOS -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_hvcmos_names) / 2,
	.func_count	= 2,
	.pad_names	= alderlake_pch_n_group_hvcmos_names,
};

const char *const alderlake_pch_n_group_vgpio_names[] = {
...
const struct gpio_group alderlake_pch_n_group_vgpio = {
	.display	= "------- GPIO Group vGPIO -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_vgpio_names) / 2,
	.func_count	= 2,
	.pad_names	= alderlake_pch_n_group_vgpio_names,
};

const char *const alderlake_pch_n_group_pcie_vgpio_names[] = {
...
const struct gpio_group alderlake_pch_n_group_pcie_vgpio = {
	.display	= "------- GPIO Group PCIe vGPIO -------",
	.pad_count	= ARRAY_SIZE(alderlake_pch_n_group_pcie_vgpio_names) / 2,
	.func_count	= 2,
	.pad_names	= alderlake_pch_n_group_pcie_vgpio_names,
};

const struct gpio_group *const alderlake_pch_n_community_0_groups[] = {
	&alderlake_pch_n_group_b,
	&alderlake_pch_n_group_t,
	&alderlake_pch_n_group_a,
};

const struct gpio_community alderlake_pch_n_community_0 = {
	.name		= "------- GPIO Community 0 -------",
	.pcr_port_id	= 0x6e,
	.group_count	= ARRAY_SIZE(alderlake_pch_n_community_0_groups),
	.groups		= alderlake_pch_n_community_0_groups,
};

const struct gpio_group *const alderlake_pch_n_community_1_groups[] = {
	&alderlake_pch_n_group_s,
	&alderlake_pch_n_group_i,
	&alderlake_pch_n_group_h,
	&alderlake_pch_n_group_d,
	&alderlake_pch_n_group_vgpio,
};

const struct gpio_community alderlake_pch_n_community_1 = {
	.name		= "------- GPIO Community 1 -------",
	.pcr_port_id	= 0x6d,
	.group_count	= ARRAY_SIZE(alderlake_pch_n_community_1_groups),
	.groups		= alderlake_pch_n_community_1_groups,
};

const struct gpio_group *const alderlake_pch_n_community_2_groups[] = {
	&alderlake_pch_n_group_gpd,
	&alderlake_pch_n_group_pcie_vgpio,
};

const struct gpio_community alderlake_pch_n_community_2 = {
	.name		= "------- GPIO Community 2 -------",
	.pcr_port_id	= 0x6c,
	.group_count	= ARRAY_SIZE(alderlake_pch_n_community_2_groups),
	.groups		= alderlake_pch_n_community_2_groups,
};

const struct gpio_group *const alderlake_pch_n_community_4_groups[] = {
	&alderlake_pch_n_group_c,
	&alderlake_pch_n_group_f,
	&alderlake_pch_n_group_hvcmos,
	&alderlake_pch_n_group_e,
};

const struct gpio_community alderlake_pch_n_community_4 = {
	.name		= "------- GPIO Community 4 -------",
	.pcr_port_id	= 0x6a,
	.group_count	= ARRAY_SIZE(alderlake_pch_n_community_4_groups),
	.groups		= alderlake_pch_n_community_4_groups,
};

const struct gpio_group *const alderlake_pch_n_community_5_groups[] = {
	&alderlake_pch_n_group_r,
};

const struct gpio_community alderlake_pch_n_community_5 = {
	.name		= "------- GPIO Community 5 -------",
	.pcr_port_id	= 0x69,
	.group_count	= ARRAY_SIZE(alderlake_pch_n_community_5_groups),
	.groups		= alderlake_pch_n_community_5_groups,
};

const struct gpio_community *const alderlake_pch_n_communities[] = {
	&alderlake_pch_n_community_0,
	&alderlake_pch_n_community_1,
	&alderlake_pch_n_community_2,
	&alderlake_pch_n_community_4,
	&alderlake_pch_n_community_5,
};
