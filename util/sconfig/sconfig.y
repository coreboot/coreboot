...
%token CHIP DEVICE REGISTER BOOL BUS RESOURCE END EQUALS HEX STRING PCI PNP I2C APIC APIC_CLUSTER PCI_DOMAIN IRQ DRQ IO NUMBER SUBSYSTEMID INHERIT IOAPIC_IRQ IOAPIC
%%
...
ioapic_irq: IOAPIC_IRQ NUMBER NUMBER NUMBER
	{ add_ioapic_info(cur_parent, strtol($<string>2, NULL, 16), strtol($<string>3, NULL, 16), strtol($<string>4, NULL, 16)); };
%%
