...
static const struct superio_registers reg_table[] = {
	...
	{0x0710, "F71869AD", {
		...
		{NOLDN, NULL,
			{0x02,0x07,0x20,0x21,0x25,0x26,0x27,0x28,0x29,0x2a,
			 0x2b,0x2c,0x2d,EOT},
			{0x00,0x00,0x08,0x14,0x00,0x00,MISC,0x38,0x6f,0x07,
			 0x0f,0x00,0x28,EOT}},
		{0x0, "Floppy",
			{0x30,0x60,0x61,0x70,0x74,0xf0,0xf2,0xf4,EOT},
			{0x01,0x03,0xf0,0x06,0x02,0x0e,0x03,0x00,EOT}},
	...
	{0x1408, "F71869ED", {
		...
		{NOLDN, NULL,
			...
			{0x00,0x00,0x08,0x14,NANA,NANA,NANA,0x00,0x00,NANA,
			0x38,0x6f,0x07,0x0f,0x00,0x28,0x00,NANA,EOT}},
		{0x00, "FDC",
			{0x30,0x60,0x61,0x70,0x74,0xf0,0xf2,0xf4,EOT},
			{0x01,0x03,0xf0,0x06,0x02,0x0e,0x03,0x00,EOT}},
		{0x01, "UART1",
		...
		{0x07, "BSEL",
			...
			{0x00,0x00,0x00,0x01,0x00,0x00,NANA,0x00,0x0a,0x00,EOT}},
		{0x0a, "PME, ACPI",
			{0x30,0xf0,0xf1,0xf2,0xf3,0xf4,0xf5,0xf6,0xf7,0xf8,
			0xf9,0xfe,0xff,EOT},
			{0x00,0x00,0x00,NANA,NANA,0x06,0x1c,0x1f,0x86,0x00,
			0x00,0x00,0x00,EOT}},
		{EOT}}},
	{0x2307, "F71889", {
		/* We assume reserved bits are read as 0. */
