...
/* IT8613 EC SMI# Mask Register 3 (06h): BANK_SEL[6-5] */
#define IT8613_EC_BANK_SEL(bank) 			\
	{						\
		.idx = 0x06,				\
		.mask = 0x60,				\
		.val = (((bank) & 3) << 5)		\
...
static const struct superio_registers reg_table[] = {
	...
	{0x8659, "IT8659E", {
		{NOLDN, NULL,
			...
			{0x86,0x59,0x07,0x40,0x00,RSVD,RSVD,EOT}},
		{0x1, "COM1",
		...
		{0x4, "Environment controller",
			{0x30,0x60,0x61,0x62,0x63,0x70,0xf0,0xf1,0xf2,0xf3,
			 0xf4,0xf5,0xf6,0xfa,0xfb,0xfd,EOT},
			{0x00,0x02,0x90,0x02,0x30,0x09,0x00,0x00,0x00,0x00,
		...
		{0x7, "GPIO",
			{0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x60,
			 0x61,0x62,0x63,0x70,0x71,0x72,0x73,0x74,0xb0,0xb1,
			 0xb2,0xb3,0xb4,0xb8,0xb9,0xba,0xbb,0xbc,0xbd,0xc0,
			 0xc1,0xc2,0xc3,0xc4,0xc8,0xc9,0xca,0xcb,0xcc,0xcd,
			 0xda,0xdb,0xe0,0xe1,0xe2,0xe3,0xe4,0xe7,0xf0,0xf1,
			 0xf2,0xf3,0xf4,0xf5,0xf6,0xf7,0xf8,0xf9,0xfa,0xfb,
			 EOT},
			{0x00,0xF3,0x00,0x00,0x00,0x00,0x48,0x89,0x00,0x00,
			 0x00,0x00,0x00,0x00,0x00,0x20,0x38,0x00,0x00,0x00,
			 0x00,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00,0x01,
			 0x00,0x00,0x40,0x00,0x01,0x00,0x00,0x40,0x00,0x00,
			 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
			 NANA,NANA,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
			 EOT}},
		{0xa, "Consumer IR",
			{0x30,0x60,0x61,0x70,0xf0,EOT},
			{0x00,0x03,0x10,0x0b,0x06,EOT}},
	...
	{0x8689, "IT8689E", {
		{NOLDN, NULL,
			{0x20,0x21,0x22,0x23,0x24,0x2e,0x2f,EOT},
			{0x86,0x89,NANA,NANA,NANA,RSVD,RSVD,EOT}},
		{0x1, "COM1",
			{0x30,0x60,0x61,0x70,0xf0,0xf1,0xf2,EOT},
			{NANA,NANA,NANA,NANA,NANA,NANA,NANA,EOT}},
		{0x2, "COM2",
	...
	{0x8784, "IT8784E-I", {
		{NOLDN, NULL,
			{0x02,0x07,0x20,0x21,0x22,0x23,0x24,0x25,0x26,
			 0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f,
			 EOT},
			{NANA,NANA,0x87,0x86,MISC,0x40,RSVD,0x00,0xf3,
		...
		{0x4, "Environment controller",
			{0x30,0x60,0x61,0x62,0x63,0x70,0xf0,0xf1,0xf2,
			 0xf3,0xf4,0xf5,0xf6,0xfa,0xfb,0xfd,EOT},
			{0x00,0x02,0x90,0x02,0x30,0x09,0x00,0x00,0x00,
			 0x00,0x00,MISC,MISC,MISC,MISC,MISC,EOT}},
		{0x5, "Keyboard",
			{0x30,0x60,0x61,0x62,0x63,0x70,0x71,0xf0,EOT},
		...
		{0x7, "GPIO",
			{0x60,0x61,0x62,0x63,0x70,0x71,0x72,0x73,0x74,0xb0,
			 ...
			 0xd9,0xe0,0xe1,0xe2,0xe3,0xe4,0xe7,0xf0,0xf1,0xf2,
	...
	{0x8613, "IT8613E", {
		{NOLDN, "BANK0",
			...
			{0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,
			 ...
			 NANA,NANA,NANA,EOT},
			 IT8613_EC_BANK_SEL(0)},
		{NOLDN, "BANK1",
			{0xc0,0xc1,0xc2,0xd0,0xd1,0xd2,0xd3,0xd4,0xd5,0xd6,
			 0xd7,0xd8,0xd9,0xda,0xdb,0xdc,0xe0,0xe1,0xe2,0xe3,
			 0xe4,0xe5,0xe6,0xe7,0xe8,0xe9,0xea,0xeb,0xec,0xed,
			 0xee,0xef,0xf0,0xf1,0xf2,0xf3,0xf4,0xf5,0xf6,0xf7,
			 0xf8,0xf9,0xfa,0xfb,0xfc,0xfd,0xfe,0xff,EOT},
			{0x00,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,EOT},
			 IT8613_EC_BANK_SEL(1)},
		{NOLDN, "BANK2",
			{0x1d,0x1e,0x1f,0x20,0x21,0x22,0x23,0x24,0x25,0x26,
			 0x27,0x28,0x29,0x2a,0x2b,0x2c,0x30,0x31,0x32,0x33,
			 0x34,0x35,0x36,0x37,0x38,0x39,0x3a,0x3b,0x3c,0x3d,
			 0x40,0x41,0x42,0x43,0x44,0x45,0x46,0x47,0x48,0x49,
			 0x4a,0x4b,0x4c,0x4d,0x50,0x51,0x52,0x53,0x54,0x55,
			 0x56,0x57,0x58,0x59,0x5a,0x5b,0x5c,0x5d,0x5e,0x5f,
			 0x6d,0x6e,0x6f,0x70,0x71,0x72,0x73,0x74,0x75,0x76,
			 EOT},
			{0x00,0x00,0x00,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,0x00,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,0x00,0x00,0x00,
			 0x00,0x00,0x00,NANA,NANA,0x00,NANA,NANA,NANA,NANA,
			 EOT},
			 IT8613_EC_BANK_SEL(2)},
		{EOT}}},
	{0x8625, "IT8625E", {
		{NOLDN, NULL,
			{0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,
	...
	{0x8659, "IT8659E", {
		{NOLDN, NULL,
			{0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,
			 ...
			 0x16,0x18,0x19,0x1b,0x1c,0x20,0x22,0x23,0x27,0x28,
			 0x29,0x2a,0x2b,0x30,0x31,0x34,0x35,0x36,0x37,0x38,
			 ...
			 0x68,0x69,0x6a,0x6b,0x6c,0x6d,0x6e,0x88,0x89,0x8a,
			 0x8b,0x8c,0x8d,0x8e,0x8f,0x90,0x91,0x92,0x93,0x94,
			 0x95,0x96,0x97,0x98,0x99,0x9c,0x9d,0x9e,0x9f,0xc0,
			 0xc1,0xc2,0xc3,0xc4,EOT},
			{0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xc0,
			 0x44,0x0f,0x00,NANA,NANA,NANA,NANA,0x07,0x40,0x00,
			 0x00,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,NANA,
			 ...
			 0x7f,0x7f,0x7f,0x80,0x00,0x7f,0x0f,0x00,0x00,0x00,
			 0x00,0x00,0x00,0x00,NANA,0xff,0x00,0x00,0x00,0xff,
			 0x00,0x00,0x00,0x00,0x00,0x00,NANA,0x00,NANA,0x00,
			 0x00,NANA,NANA,NANA,EOT}},
		{EOT}}},
	{0x8716, "IT8716F", {
		{NOLDN, NULL,
	...
	{0x8784, "IT8784E-I", {
		{NOLDN, NULL,
			{0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,
			 ...
			 0x9c,0x9d,0x9e,0x9f,0xc0,0xc1,0xc2,0xc3,0xc4,EOT},
			{0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,
			 ...
			 0x00,MISC,0x00,MISC,0x00,0x00,MISC,MISC,MISC,EOT}},
		{EOT}}},
	{0x8786, "IT8786E-I", {
		{NOLDN, NULL,
			{0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,
